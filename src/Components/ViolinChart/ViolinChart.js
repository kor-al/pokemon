...
class ViolinChart extends Component {
  ...
  createViolinChart() {
    ...
    const nodeg_translated = select(node).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
    ...
    nodeg_translated.append("g").attr("transform", "translate(0," + height + ")").call(axisBottom(xScale));
