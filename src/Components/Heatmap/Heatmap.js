...
class Heatmap extends Component {
  ...
  mousemove = function (e) {
    ...
    this.tooltip.innerHTML = `${
      tile.dataset.name
    } - damage by <span class=${tile.dataset.var.slice(
      8
    )}>${tile.dataset.var.slice(8)}</span> is ${tile.dataset.val}`;
  ...
  render() {
    ...
    return (
      <div className="heatmap">
        ...
        {/* <div className="helper">Make your team resistant to different attacks </div> */}
      </div>
    );
  }
}
